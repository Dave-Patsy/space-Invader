...
class Squid:
    ...
    def __init__(self, setting: settings, position: Vector2):
        ...
        self.score = setting.squid_score
        self.sprite_sheet = spriteSheet(setting.squid_filename, 5, 3)
        self.rect = pygame.Rect(self.position.x, self.position.y, self.sprite_sheet.cell_width,
